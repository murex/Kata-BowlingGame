...
> ***Important Note***
>
> The instructions provided below are for running the kata locally on your machine.
> This implies in particular that Haskell tools have been previously installed locally.
>
> If for any reason you do not wish to install these tools but would like to give the kata a
> try, you can refer to [this guide](GETTING_STARTED_IN_DEV_CONTAINER.md) in order to run it
...
- [haskell](https://www.haskell.org/downloads/)
  <details><summary>Haskell Version</summary>

  The kata is configured to run with Stack's [LTS Haskell 21.25](https://www.stackage.org/lts-21.25) (GHC 9.4.8) by default.

  To use a different version, simply modify the line below in [stack.yaml](stack.yaml).
...
>
> IntelliJ's Haskell plugin is not available with the Community edition.
> You can still use it as an editor for Haskell files, but you will not
> be able to use the benefits brought by the Haskell plugin, such as syntax highlighting,
...
> for instructions related to installation of IntelliJ's Haskell plugin.
...
Open Visual Studio Code, choose `Open Folder`, navigate to `Kata-BowlingGame` / `haskell`
